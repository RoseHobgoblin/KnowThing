...
-- A deliberately authored celestial seed for an otherwise empty KnowThing DB.
...
DO $$
BEGIN
	IF EXISTS (SELECT 1 FROM celestial_sectors WHERE slug = 'palimpsest-reach') THEN
		RAISE EXCEPTION 'The Palimpsest Reach is already seeded';
	END IF;
END $$;

INSERT INTO celestial_sectors (
...
(
	'star', 'Orison', 'orison', (SELECT id FROM celestial_bodies WHERE slug = 'orison-fold'),
...
(
	'star', 'Palinode', 'palinode', (SELECT id FROM celestial_bodies WHERE slug = 'orison'),
...
(
	'star', 'Aster Vale', 'aster-vale', (SELECT id FROM celestial_bodies WHERE slug = 'glasswake'),
...
(
	'star', 'Vey', 'vey', (SELECT id FROM celestial_bodies WHERE slug = 'veys-anvil'),
...
(
	'star', 'Clinker', 'clinker', (SELECT id FROM celestial_bodies WHERE slug = 'vey'),
...
(
	'star', 'Cantor', 'cantor', (SELECT id FROM celestial_bodies WHERE slug = 'drowned-choir'),
...
(
	'star', 'Undertone', 'undertone', (SELECT id FROM celestial_bodies WHERE slug = 'cantor'),
...
(
	'star', 'Needle', 'needle', (SELECT id FROM celestial_bodies WHERE slug = 'needles-rest'),
...
(
	'body', 'Nacre', 'nacre', (SELECT id FROM celestial_bodies WHERE slug = 'orison'), 'planet',
...
(
	'body', 'Bellweather', 'bellweather', (SELECT id FROM celestial_bodies WHERE slug = 'nacre'), 'planet',
...
(
	'body', 'Ash of Noon', 'ash-of-noon', (SELECT id FROM celestial_bodies WHERE slug = 'nacre'), 'asteroid',
...
(
	'body', 'The Redaction', 'the-redaction', (SELECT id FROM celestial_bodies WHERE slug = 'orison'), 'asteroid',
...
(
	'body', 'Serein', 'serein', (SELECT id FROM celestial_bodies WHERE slug = 'orison'), 'planet',
...
(
	'body', 'Hush', 'hush', (SELECT id FROM celestial_bodies WHERE slug = 'serein'), 'planet',
...
(
	'body', 'The Marginalia', 'the-marginalia', (SELECT id FROM celestial_bodies WHERE slug = 'serein'), 'ring_system',
...
(
	'body', 'Vitria', 'vitria', (SELECT id FROM celestial_bodies WHERE slug = 'aster-vale'), 'planet',
...
(
	'body', 'Heliograph', 'heliograph', (SELECT id FROM celestial_bodies WHERE slug = 'aster-vale'), 'planet',
...
(
	'body', 'Proof', 'proof', (SELECT id FROM celestial_bodies WHERE slug = 'heliograph'), 'planet',
...
(
	'body', 'Ferrule', 'ferrule', (SELECT id FROM celestial_bodies WHERE slug = 'vey'), 'planet',
...
(
	'body', 'Anvilwake', 'anvilwake', (SELECT id FROM celestial_bodies WHERE slug = 'vey'), 'planet',
...
(
	'body', 'Temper', 'temper', (SELECT id FROM celestial_bodies WHERE slug = 'anvilwake'), 'planet',
...
(
	'body', 'Threnody', 'threnody', (SELECT id FROM celestial_bodies WHERE slug = 'drowned-choir'), 'planet',
...
(
	'body', 'Dirge', 'dirge', (SELECT id FROM celestial_bodies WHERE slug = 'threnody'), 'planet',
...
(
	'body', 'Wakeglass', 'wakeglass', (SELECT id FROM celestial_bodies WHERE slug = 'drowned-choir'), 'asteroid',
...
(
	'body', 'Cautery', 'cautery', (SELECT id FROM celestial_bodies WHERE slug = 'needle'), 'asteroid',
...
(
	'body', 'Spindle', 'spindle', (SELECT id FROM celestial_bodies WHERE slug = 'needle'), 'planet',
...
UPDATE celestial_bodies AS child
...
JOIN celestial_bodies AS parent ON parent.slug = link.parent_slug
...
INSERT INTO celestial_sector_roots (
	sector_id, body_id, x, y, z, position_provenance, position_uncertainty, notes
) VALUES
((SELECT id FROM celestial_sectors WHERE slug = 'palimpsest-reach'), (SELECT id FROM celestial_bodies WHERE slug = 'orison-fold'), 0, 0, 0, 'authored', 0, 'Definition of the object-centred origin.'),
((SELECT id FROM celestial_sectors WHERE slug = 'palimpsest-reach'), (SELECT id FROM celestial_bodies WHERE slug = 'glasswake'), 8.4, -3.2, 1.1, 'authored', 0.03, 'Concordance-era triangulation.'),
((SELECT id FROM celestial_sectors WHERE slug = 'palimpsest-reach'), (SELECT id FROM celestial_bodies WHERE slug = 'veys-anvil'), -11.6, 4.7, -2.9, 'authored', 0.05, 'Corrected for the giant primary''s photocentre.'),
((SELECT id FROM celestial_sectors WHERE slug = 'palimpsest-reach'), (SELECT id FROM celestial_bodies WHERE slug = 'drowned-choir'), 3.1, 10.8, 4.2, 'authored', 0.04, 'Binary barycentre, not Cantor''s instantaneous position.'),
((SELECT id FROM celestial_sectors WHERE slug = 'palimpsest-reach'), (SELECT id FROM celestial_bodies WHERE slug = 'needles-rest'), -6.8, -9.4, 6.3, 'authored', 0.02, 'White-dwarf photocentre; debris stream excluded.');

UPDATE celestial_sectors
SET origin_kind = 'object-centred',
	origin_body_id = (SELECT id FROM celestial_bodies WHERE slug = 'orison-fold'),
	updated_at = NOW()
...
VALUES (
	...
	true,
	(SELECT id FROM celestial_bodies WHERE slug = 'nacre'),
	'{
		"first_week_day": 0,
		"weekdays": [
...
BEGIN
	SELECT COUNT(*) INTO sector_count FROM celestial_sectors WHERE slug = 'palimpsest-reach';
	SELECT COUNT(*) INTO root_count FROM celestial_sector_roots;
	SELECT COUNT(*) INTO system_count FROM celestial_bodies WHERE kind = 'system';
	SELECT COUNT(*) INTO star_count FROM celestial_bodies WHERE kind = 'star';
	SELECT COUNT(*) INTO body_count FROM celestial_bodies WHERE kind = 'body';
	SELECT COUNT(*) INTO orphan_count FROM celestial_bodies WHERE kind <> 'system' AND parent_id IS NULL;
