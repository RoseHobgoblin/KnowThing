...
INSERT INTO stars (name, slug, page_slug, spectral_type, mass, radius, luminosity, luminosity_visual, temperature, age, color, orbital_period, semi_major_axis, semi_major_axis_au, eccentricity, periastron, apastron, companion, parent_star_id, extra, description)
VALUES (
...
-- Verify
SELECT id, name, slug, spectral_type, page_slug, parent_star_id FROM stars ORDER BY id;
