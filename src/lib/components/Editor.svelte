<script lang="ts">
	...
	const wikiHighlight = HighlightStyle.define([
		...
		{ tag: tags.keyword, color: '#E9C349', fontWeight: 'bold' },
		{ tag: tags.link, color: 'var(--color-link)' },
		{ tag: tags.url, color: '#7EB8DA' },
		{ tag: tags.operator, color: '#888' },
		{ tag: tags.string, color: '#B8A080' },
		{ tag: tags.meta, color: '#9580B0' },
		{ tag: tags.tagName, color: '#CC7A8A' },
		{ tag: tags.typeName, color: '#80A8A0' },
		{ tag: tags.variableName, color: '#CC6666' },
