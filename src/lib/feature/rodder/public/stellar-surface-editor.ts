...
import { parseMediaAssetBinding } from '$lib/feature/media/public/media-binding.js'
...
export function stellarSurfaceRecipeFromDraft(draft: Record<string, unknown>): StellarSurfaceRecipe {
	const binding = parseMediaAssetBinding(draft.stellarPhotosphereMap, rodderMediaInterpretation('stellar-photosphere'))
