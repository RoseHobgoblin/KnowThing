<script lang="ts">
	...
	import RodderSurfacePreview from '$lib/feature/rodder/public/ui/RodderSurfacePreview.svelte'
	import RingSystemEditor from '$lib/feature/rodder/public/ui/RingSystemEditor.svelte'
	import MediaAssetPicker from '$lib/feature/media/public/ui/MediaAssetPicker.svelte'
	import { rodderMediaProfile } from '../media-binding.js'
	import { rodderConfigureBreadcrumbs } from '$lib/utils/breadcrumbs.js'
	import { pushSuccess, pushError } from '$lib/notifications.svelte'
	import { goto } from '$app/navigation'
	import { resolve } from '$app/paths'
	import { createMutation } from '@tanstack/svelte-query'
	import { saveRodderEntity } from '../rodder-client.js'
	...
	} from '$lib/feature/rodder/public/form-registry.js'
	import { surfaceRecipeFromDraft } from '$lib/feature/rodder/public/surface-editor.js'
	import { weatherRecipeFromDraft } from '$lib/feature/rodder/public/weather-editor.js'
	import { stellarSurfaceRecipeFromDraft } from '$lib/feature/rodder/public/stellar-surface-editor.js'
	import { resolveHostStarTemperatureK } from '$lib/feature/rodder/public/stellar-surface-model.js'
	import { spectralColor } from '$lib/feature/rodder/public/colors.js'
	...
	const entityMutation = createMutation(() => ({
		mutationFn: ({ method, slug, body }: { method: 'PUT' | 'DELETE', slug: string, body?: unknown }) =>
			saveRodderEntity<{ slug?: string }>(slug, method, body),
	}))
...
{#snippet fieldControl(spec: FieldSpec)}
	...
	{:else if spec.control === 'media'}
		<MediaAssetPicker
			label={labelOf(spec, ctx)}
			hint={spec.hint}
			profile={rodderMediaProfile(spec.purpose)}
