...
import { getSectorContextForRoot, listSectorReferences, type SectorContext } from '$lib/feature/rodder/public/server/sectors.server.js'
import type { ApparentSkyResult } from '$lib/feature/rodder/public/apparent-sky.js'
import { buildApparentSky } from '$lib/feature/rodder/public/apparent-sky.js'
import type { RodderEntityDocument } from '$lib/feature/rodder/public/consumer-contract.js'
...
export async function loadRodderDetail(ctx: RodderDetailContext): Promise<RodderDetailData> {
	...
	const document = await resolveRodderEntityDocument(entity.slug, ctx.calendarPort)
