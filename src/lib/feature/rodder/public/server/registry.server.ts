...
import {
	rodderBodies,
} from '$lib/feature/rodder/server/schema.server.js'
import { contentLinks, contentRecords } from '$lib/server/db/core-schema.js'
import { RODDER_TREE_CTE } from '$lib/feature/rodder/server/hierarchy.server.js'
import { projectRingSystems, type RingProjectionRow } from '$lib/feature/rodder/public/ring-projection.js'
import {
...
export async function listRootBodyIds(rootId: number): Promise<number[]> {
