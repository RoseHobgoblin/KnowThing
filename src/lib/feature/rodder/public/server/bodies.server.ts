...
} from '$lib/feature/rodder/public/schema.js'
import { emptyRingSystem } from '$lib/feature/rodder/public/ring-system.js'
import { validateParentKind, isRodderKind, type RodderKind } from '$lib/feature/rodder/public/parent-rules.js'
import { mergeSectorPosition, type SectorPositionMerge } from '$lib/feature/rodder/public/sector-position.js'
import {
	...
	resolveSectorId,
	upsertSectorRoot,
} from '$lib/feature/rodder/public/server/sectors.server.js'
import { rodderPresets, type BodyPreset } from '$lib/feature/rodder/public/presets.js'
...
import { replaceMediaBindingsForOwner } from '$lib/feature/media/public/resolve-image.server.js'
import { normalizeRodderMediaBindings } from '../../server/media-bindings.server.js'
import {
...
export async function deleteRodder(slug: string) {
	...
	await db.transaction(async (tx) => {
		...
		await removeMediaBindingsForOwners(tx, 'rodder', removedIds)
