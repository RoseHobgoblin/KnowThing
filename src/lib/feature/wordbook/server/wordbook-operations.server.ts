...
import { getInflectionTable, rebuildInflectedForms } from '$lib/feature/wordbook/public/server/inflection.server.js'
...
const LETTER_BUCKET_SQL = sql`
  ...
  END
`
const DEFAULT_LANGUAGE_PAGINATION = { limit: 200, offset: 0 }
...
export async function listLanguageEntries(
	languageId: number,
	letter: string | null,
	pagination: { limit: number, offset: number } = DEFAULT_LANGUAGE_PAGINATION,
